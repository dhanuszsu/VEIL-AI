...
import { VeilBridge, ExecutionReport } from "./veilBridge.js";
...
export async function runEvaluatorBenchmark(page: Page, demoUrl = "http://localhost:3002"): Promise<ScenarioResult[]> {
